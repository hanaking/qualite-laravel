node("master") {
    try {
        stage('prepare') {
            git credentialsId: '8bb830bb-ad2d-4c58-a2b5-5c0daf5e85f1', url: 'https://github.com/bkvin/qualite-laravel.git', branch: 'master'
        ...
        stage('git'){  
            ...
            if (GIT_MERGE != "Already up-to-date.") { 
                ...
                sshagent(['8bb830bb-ad2d-4c58-a2b5-5c0daf5e85f1']) {
